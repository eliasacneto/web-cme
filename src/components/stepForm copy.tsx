...
//         todosDias: false, // Desmarcar "todosDias" se dias individuais estão sendo marcados
//       };
//       setSelectedDays(newSelectedDays);
//     };
...
//   const handleCheckEmailExists = async (values: FormValues) => {
//     console.log(JSON.stringify(values, null, 2));
//     try {
//       const emailCheckResponse = await axios.post(
//         "http://localhost:8000/lead/check-email",
//         {
...
//         return true; // Retorna true se o e-mail já existir
//       }
//     } catch (error) {
//       console.error("Erro ao enviar os dados para a API", error);
//     }
//     return false; // Retorna false se o e-mail não existir
//   };
